...
resta(1, 2);
console.log(resultado_resta); // Va a dar un error. En este punto el script no tiene ni idea donde esta definida la variable 'resultado_resta'; pues no está definida en su ámbito o scope
